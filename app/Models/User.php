...
class User extends Authenticatable
{
    ...
    {
        return $this->hasOne('App\Models\Perfil', 'id_usuario');
    }
    ...
    {
        return $this->hasMany('App\Models\Video', 'id_usuario');
    }
    ...
    {
        return $this->belongsToMany('App\Models\Role', 'role_user', 'id_usuario', 'id_rol');
    }
